...
if complexity <= 3:
    print(f"\nYour password complexity score is {Fore.RED}{complexity}{Fore.RESET}/7 {emoji.emojize(':thumbs_down:')}")
elif complexity > 3:
     print(f"\nYour password complexity score is {Fore.GREEN}{complexity}{Fore.RESET}/7 {emoji.emojize(':thumbs_up:')}")
...
if user_password in track(common_pass, description='[green]Please wait...'):
    ...
    print(f"\nPassword is secure, enough to waste the hackers time a lil! {emoji.emojize(':winking_face:')}")
